 ...
 */
const QUICKNODE_NETWORK_MAP = {
    [exports.Network.ETH_MAINNET]: { subdomain: null },
    [exports.Network.BASE_MAINNET]: { subdomain: 'base-mainnet' },
    [exports.Network.BNB_MAINNET]: { subdomain: 'bsc' },
    [exports.Network.AVAX_MAINNET]: { subdomain: 'avalanche-mainnet', httpSuffix: '/ext/bc/C/rpc/', wsSuffix: '/ext/bc/C/ws/' },
    [exports.Network.ARB_MAINNET]: { subdomain: 'arbitrum-mainnet' },
    [exports.Network.MONAD_MAINNET]: { subdomain: 'monad-mainnet' },
};
/**
 * Get QuickNode configuration from environment
 * Expects: QUICKNODE_SLUG and QUICKNODE_API_KEY
 */
function getQuickNodeConfig() {
 ...
 */
function buildQuickNodeHttpUrl(network) {
 ...
 */
function buildQuickNodeWsUrl(network) {
    const mapping = QUICKNODE_NETWORK_MAP[network];
    if (!mapping)
        return null;
    const config = getQuickNodeConfig();
...
const EthersNetwork = {
    ...
    [exports.Network.MONAD_MAINNET]: 'monad-mainnet',
